// TASK 
// make a email field in the incident form and whenever the caller is selected then his email should come in the email field 

//  APPROACH
//-  make a string field name email
//- make a script include
